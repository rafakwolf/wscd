inherited frmRelatorioProdutoVencimento: TfrmRelatorioProdutoVencimento
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object dbdDataVenc: TPLDBEditDateTimePicker [0]
    Left = 84
    Top = 104
    Width = 341
    Height = 21
    Hint = 'Produtos vencidos '#13#10'apartir desta data...'
    Date = 39284.874990208340000000
    Time = 39284.874990208340000000
    TabOrder = 2
    DataField = 'DATA'
    DataSource = dsPadrao
    ReadOnly = False
    ...
    EditLabel.Caption = 'Data Limite'
    EditLabel.FocusControl = dbdDataVenc
    Required = False
  end
  ...
  object dbeGrupo: TPLDBEdit [4]
    ...
    Button.Visible = False
    Button.AutoSize = True
    OnClickButton = dbeGrupoClickButton
    ReadOnlyChangesColor = False
  end
