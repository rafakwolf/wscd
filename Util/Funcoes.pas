...
begin
  UniGUIDialogs.MessageDlg(msg, TMsgDlgType.mtWarning, [TMsgDlgBtn.mbOK]);
end;

procedure MsgAviso(title, msg: string);
begin
  UniGUIDialogs.MessageDlg(msg, TMsgDlgType.mtInformation, [TMsgDlgBtn.mbOK]);
end;

procedure MsgErro(title, msg: string);
begin
  UniGUIDialogs.MessageDlg(msg, TMsgDlgType.mtError, [TMsgDlgBtn.mbOK]);
end;
...
function MsgSN(msg: string): boolean;
begin
  Result := UniGUIDialogs.MessageDlg(msg, TMsgDlgType.mtConfirmation,
    [TMsgDlgBtn.mbYes, TMsgDlgBtn.mbNo]) = 1;
end;
