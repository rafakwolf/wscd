inherited frmRelatorioComissaoVenda: TfrmRelatorioComissaoVenda
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object dbdtpDataFim: TPLDBEditDateTimePicker [0]
    Left = 16
    Top = 104
    Width = 137
    Height = 21
    Date = 39691.912171041660000000
    Time = 39691.912171041660000000
    TabOrder = 2
    DataField = 'DATAFIM'
    DataSource = dsData
    ReadOnly = False
    ...
    EditLabel.FocusControl = dbdtpDataFim
    EditLabel.LabelPosition = lpAbove
    Required = False
  end
  object dbdtpDataIni: TPLDBEditDateTimePicker [1]
    Left = 16
    Top = 64
    Width = 137
    Height = 21
    Date = 39691.911967222220000000
    Time = 39691.911967222220000000
    TabOrder = 1
    DataField = 'DATAINI'
    DataSource = dsData
    ReadOnly = False
    ...
    EditLabel.FocusControl = dbdtpDataIni
    EditLabel.LabelPosition = lpAbove
    Required = False
  end
  object dbeVendedor: TPLDBEdit [2]
    Left = 16
    Top = 24
    Width = 299
    Height = 21
    ...
    EditLabel.FocusControl = dbeVendedor
    EditLabel.LabelPosition = lpAbove
    PrimaryKey = False
    Button.Left = 316
    Button.Top = 24
