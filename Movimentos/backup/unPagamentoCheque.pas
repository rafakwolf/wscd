...
begin
  ...
  begin
    ...
    begin
      MsgErro('O valor informado para recebimento inv�lido, tente novamente.');
      Exit;
    end;
  end
  ...
  begin
    ...
    begin
      MsgErro('O valor informado para pagamento inv�lido, tente novamente.');
      Exit;
    end;
  end;
