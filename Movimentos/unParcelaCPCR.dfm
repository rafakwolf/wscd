inherited frmParcelaCPCR: TfrmParcelaCPCR
  ...
  object dbeCodigo: TPLDBEdit
    ...
    EditLabel.FocusControl = dbeCodigo
  ...
  object dbeNome: TPLDBEdit
    ...
    Button.ShowHint = True
    Button.Visible = False
    Button.OnClick = dbeNomeClickButton
    Button.AutoSize = True
    OnClickButton = dbeNomeClickButton
    ReadOnlyChangesColor = False
  end
  ...
  object dbdtpData: TPLDBEditDateTimePicker
    Left = 8
    Top = 64
    Width = 113
    Height = 21
    Date = 39698.894221273150000000
    Time = 39698.894221273150000000
    TabOrder = 2
    DataField = 'DATA'
    DataSource = dsPadrao
    ReadOnly = False
    ...
    EditLabel.FocusControl = dbdtpData
    EditLabel.LabelPosition = lpAbove
    Required = False
  end
  ...
  object sqldContasPagar: TPLSQLDataSet
    CommandText = 
  ...
  object sqldReceber: TPLSQLDataSet
    CommandText = 
