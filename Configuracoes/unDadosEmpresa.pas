...
//    begin
//      if UniGUIDialogs.MessageDlg('A chave de libera��o informada est� incorreta '+
...
//    tvExpirouPrazo:
//    begin
//      if UniGUIDialogs.MessageDlg('A chave de libera��o do sistema est� expirada.'+#13+
...
//    tvBloqueioSistema:
//    begin
//      if UniGUIDialogs.MessageDlg('CHAVE DE LIBERA��O EXPIRADA.'+#13+
...
//    tvPrazoMtoLongo:
//    begin
//      if UniGUIDialogs.MessageDlg('A Chave de Libera��o informada est� fora de um per�odo v�lido. '+
...
//    begin
//      if UniGUIDialogs.MessageDlg(PChar('N�o � poss�vel utilizar o sistema sem informar uma chave de libera��o v�lida. '+
